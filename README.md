...
## Quick demo
The file fft_test1.py from official demo has a demo code of implementing FFT using scipy.fft, from:
    https://docs.scipy.org/doc/scipy/reference/tutorial/fft.html#d-discrete-fourier-transforms
    But, This demo of scipy has a small bug: the f-axis missed the median point of the symmetrical FT spectrum,
    so that it will yield a very tiny frequency shift (e.g., < 0.001 Hz) as shown in the plot below.
    The correct demo is also included in:
```
fft_test1.py
```
